          ...
          <div className={styles.content}>
            <div className="flex justify-between items-center bg-right bg-cover">
              <div>
                ...
                <p className="max-w-2xl leading-7 my-4">
                  Coding bootcamps enable students with little coding
                  proficiency to focus on the most important aspects of coding
                  and immediately apply their new coding skills to solve
                  real-world problems.
                </p>
                <p className="max-w-2xl leading-7 my-4">
                  The goal of many coding bootcamp attendees is to transition
                  into a career in web development. They do this by learning to
                  build applications at a professional level - which provides
                  the foundation they need to build production-ready
                  applications and demonstrate they have the skills to add real
            ...
            <div className="flex justify-between items-center lg:bg-p-quadro bg-right bg-cover my-32">
              ...
              <div className="lg:text-right">
                ...
                <p className="font-bold max-w-2xl leading-7 my-4 ml-auto">
                  ...
                  Lyft, technology driven transportation companies. Companies
                  like Apple, Square and PayPal are changing how we pay for
                  things. It seems every industry is being radically impacted by
                ...
                <p className="max-w-2xl leading-7 my-4 ml-auto">
                  Attending a coding bootcamp is a viable path to transition
                  into a career in web development as an alternative (or
                  supplement) to graduating with a 4 year degree in Computer
                  Science to helping fill the need of skilled software engineers
                  in industry.
                </p>
              </div>
            </div>
            <div className="my-20">
              ...
              <p className="font-bold text-center leading-7 my-4">
                ...
                work and there are many different skills that are important to
                learn!
              </p>
              <p className="text-center leading-7 my-4">
                Regardless of the program you choose to enroll in its important
                to know that as a professional developer it is important to have
                ...
                databases are all important skills to learn. Within each of
                these categories of technologies there are specific
                technologies, each with trade-offs and benefits both for and
                against them.
              </p>
              <p className="text-center leading-7 my-4">
